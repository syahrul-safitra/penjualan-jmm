...
@section('container')
    <div class="col-12">
        <h4 class="mb-2"><i class="bi bi-box-arrow-up me-2"></i>Detail Pemesanan Product</h4>
        {{-- Session Message --}}
        ...
        <div class="bg-light rounded h-100 p-4">
            <div class="d-flex gap-2">
                ...
                <a href="{{ url('order-product') }}" class="btn btn-info mb-3"><i
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <form class="modal-content" action="{{ url('set-status-product/' . $order->id) }}"
