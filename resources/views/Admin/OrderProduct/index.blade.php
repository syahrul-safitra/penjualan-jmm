...
@section('container')
    <div class="col-12">
        ...
        <h4 class="mb-2"><i class="bi bi-cart4 me-2"></i> Order Product</h4>
        {{-- Session Message --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-4">
                                        ...
                                        <a href="{{ url('order-product/' . $item->id . '/edit') }}" class="btn btn-warning"
                                            style="padding-top: 2px; padding-bottom: 2px; padding-left: 5px; padding-right: 5px"><i
                                                class="bi bi-pencil-square"></i></a>


                                        <form action="{{ url('order-product/' . $item->id) }}" method="POST">
                                            @csrf
