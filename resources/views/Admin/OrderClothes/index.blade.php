...
@section('container')
    <div class="col-12">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ url('cetak-order-pakaian') }}" method="POST">
        ...
        <h4 class="mb-2"><i class="bi bi-cart4 me-2"></i> Order Pakaian</h4>
        {{-- Session Message --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-4">
                                        ...
                                        <a href="{{ url('order/' . $item->id . '/edit') }}" class="btn btn-warning"
                                        ...
                                        <form action="{{ url('order-cloth/' . $item->id) }}" method="POST">
                                            @csrf
                                            <button class="btn btn btn-danger btn-delete-suratmasuk"
                                                onclick="return confirm('Data order pakaian akan dihapus.')"
