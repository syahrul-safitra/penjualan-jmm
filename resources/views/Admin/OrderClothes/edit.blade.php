...
@section('container')
    <div class="col-12">
        <h4 class="mb-2"><i class="bi bi-box-arrow-up me-2"></i>Detail Pemesanan Pakaian</h4>
        {{-- Session Message --}}
        ...
        <div class="bg-light rounded h-100 p-4">
            <div class="d-flex gap-2">
                ...
                <a href="{{ url('order-pakaian') }}" class="btn btn-info mb-3"><i
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <form class="modal-content" action="{{ url('set-status-cloth/' . $order->id) }}"
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row" style="width: 30%">No WA</th>
                        <td style="width: 5%">:</td>
                        <td style="width: 65%">{{ $order->customer->no_wa }}</td>
                    </tr>
                    <tr>
                        <th scope="row" style="width: 30%">Alamat</th>
                        <td style="width: 5%">:</td>
                        <td style="width: 65%">{{ $order->customer->alamat }}</td>
                    </tr>
                    <tr>
                        <th scope="row" style="width: 30%">Nama Produk</th>
                        <td style="width: 5%">:</td>
                        <td style="width: 65%">{{ $order->cloth->nama }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 5%">:</td>
                        <td style="width: 65%">{{ $order->ukuran }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th scope="row" style="width: 30%">Desain Pakaian</th>
                        <td style="width: 5%">:</td>
                        <td><a href="{{ asset('file/' . $order->desain) }}" class="btn btn-info"
                                style="padding-top: 2px; padding-bottom: 2px; padding-left: 5px; padding-right: 5px;"><i
                                    class="bi bi-easel"></i></a>
                        </td>
                    </tr>
                    <tr>
